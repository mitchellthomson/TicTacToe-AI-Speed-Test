...
class Game:
        ...
        for i in range(self.board.size):
            for j in range(self.board.size):
                ...
                if self.board.spots[board_spot_index] == "-":
                    ...
                    score = self.mini_max(self.board, self.win_length + 2, False, enemy_piece)
    ...
    def mini_max(self, board, depth, is_maximizing, playing_piece):
        self.count += 1
        ...
        if is_maximizing:
            ...
            for i in range(board.size):
                for j in range(board.size):
                    ...
                    if board.spots[board_spot_index] == "-":
                        ...
                        score = self.mini_max(board, depth - 1, False, oppsing_piece)
            ...
            for i in range(board.size):
                for j in range(board.size):
                    ...
                    if board.spots[board_spot_index] == "-":
                        board.spots[board_spot_index] = playing_piece
                        score = self.mini_max(board, depth - 1, True, oppsing_piece)
                        board.spots[board_spot_index] = "-"
